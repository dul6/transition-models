...
tmp<volScalarField> kOmegaSSTGam<BasicTurbulenceModel>::F1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTGam<BasicTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*kOmegaSST<BasicTurbulenceModel>::Pk(G) + P_klim_;
}

template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTGam<BasicTurbulenceModel>::epsilonByk
(
...
kOmegaSSTGam<BasicTurbulenceModel>::ReThetac
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTGam<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTGam<BasicTurbulenceModel>::kOmegaSSTGam
(
...
template<class BasicTurbulenceModel>
bool kOmegaSSTGam<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTGam<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void kOmegaSSTGam<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
