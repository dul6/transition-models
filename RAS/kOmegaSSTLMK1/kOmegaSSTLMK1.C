...
tmp<volScalarField> kOmegaSSTLMK1<BasicTurbulenceModel>::F1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMK1<BasicTurbulenceModel>::Pk
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMK1<BasicTurbulenceModel>::epsilonByk
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMK1<BasicTurbulenceModel>::Fthetat
(
...
kOmegaSSTLMK1<BasicTurbulenceModel>::ReThetac() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMK1<BasicTurbulenceModel>::Flength
(
    const volScalarField::Internal& nu
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMK1<BasicTurbulenceModel>::ReThetat0
(
    const volScalarField::Internal& Us,
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMK1<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTLMK1<BasicTurbulenceModel>::kOmegaSSTLMK1
(
...
template<class BasicTurbulenceModel>
bool kOmegaSSTLMK1<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMK1<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMK1<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
