...
tmp<volScalarField> kOmegaSSTLMIDDES<BasicTurbulenceModel>::F1
(
...
) const
{
    ...
    return max(kOmegaSSTIDDES<BasicTurbulenceModel>::F1(CDkOmega), F3);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIDDES<BasicTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*kOmegaSSTIDDES<BasicTurbulenceModel>::Pk(G);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIDDES<BasicTurbulenceModel>::epsilonByk
(
...
) const
{
    return
       ...
       *kOmegaSSTIDDES<BasicTurbulenceModel>::epsilonByk(F1, gradU);//no problem
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIDDES<BasicTurbulenceModel>::Fthetat
(
...
kOmegaSSTLMIDDES<BasicTurbulenceModel>::ReThetac() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIDDES<BasicTurbulenceModel>::Flength
(
    const volScalarField::Internal& nu
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIDDES<BasicTurbulenceModel>::ReThetat0
(
    const volScalarField::Internal& Us,
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIDDES<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTLMIDDES<BasicTurbulenceModel>::kOmegaSSTLMIDDES
(
...
:
    kOmegaSSTIDDES<BasicTurbulenceModel>
    (
        alpha,
        rho,
        U,
...
template<class BasicTurbulenceModel>
bool kOmegaSSTLMIDDES<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMIDDES<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMIDDES<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    // Correct k and omega
    kOmegaSSTIDDES<BasicTurbulenceModel>::correct();
