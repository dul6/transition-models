...
tmp<volScalarField> kOmegaSSTLMDDES<BasicTurbulenceModel>::F1
(
...
) const
{
    ...
    return max(kOmegaSSTDDES<BasicTurbulenceModel>::F1(CDkOmega), F3);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMDDES<BasicTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*kOmegaSSTDDES<BasicTurbulenceModel>::Pk(G);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMDDES<BasicTurbulenceModel>::epsilonByk
(
...
) const
{
    return
       ...
       *kOmegaSSTDDES<BasicTurbulenceModel>::epsilonByk(F1, gradU);//no problem
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMDDES<BasicTurbulenceModel>::Fthetat
(
...
kOmegaSSTLMDDES<BasicTurbulenceModel>::ReThetac() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMDDES<BasicTurbulenceModel>::Flength
(
    const volScalarField::Internal& nu
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMDDES<BasicTurbulenceModel>::ReThetat0
(
    const volScalarField::Internal& Us,
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMDDES<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTLMDDES<BasicTurbulenceModel>::kOmegaSSTLMDDES
(
...
template<class BasicTurbulenceModel>
bool kOmegaSSTLMDDES<BasicTurbulenceModel>::read()
{
    if (kOmegaSSTDDES<BasicTurbulenceModel>::read())
    {
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMDDES<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMDDES<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    // Correct k and omega
    kOmegaSSTDDES<BasicTurbulenceModel>::correct();
