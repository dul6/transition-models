...
tmp<volScalarField> kOmegaSSTGamDDES<BasicTurbulenceModel>::F1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTGamDDES<BasicTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*kOmegaSSTDDES<BasicTurbulenceModel>::Pk(G) + P_klim_;
}

template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTGamDDES<BasicTurbulenceModel>::epsilonByk
(
...
) const
{
    return
       ...
       *kOmegaSSTDDES<BasicTurbulenceModel>::epsilonByk(F1, gradU);
}

template<class BasicTurbulenceModel>
tmp<volScalarField::Internal>
kOmegaSSTGamDDES<BasicTurbulenceModel>::ReThetac
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTGamDDES<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTGamDDES<BasicTurbulenceModel>::kOmegaSSTGamDDES
(
...
template<class BasicTurbulenceModel>
bool kOmegaSSTGamDDES<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTGamDDES<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void kOmegaSSTGamDDES<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
