...
tmp<volScalarField> kOmegaSSTGamIDDES<BasicTurbulenceModel>::F1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTGamIDDES<BasicTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*kOmegaSSTIDDES<BasicTurbulenceModel>::Pk(G) + P_klim_;
}

template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTGamIDDES<BasicTurbulenceModel>::epsilonByk
(
...
) const
{
    return
       ...
       *kOmegaSSTIDDES<BasicTurbulenceModel>::epsilonByk(F1, gradU);
}

template<class BasicTurbulenceModel>
tmp<volScalarField::Internal>
kOmegaSSTGamIDDES<BasicTurbulenceModel>::ReThetac
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTGamIDDES<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTGamIDDES<BasicTurbulenceModel>::kOmegaSSTGamIDDES
(
...
template<class BasicTurbulenceModel>
bool kOmegaSSTGamIDDES<BasicTurbulenceModel>::read()
{
    if (kOmegaSSTIDDES<BasicTurbulenceModel>::read())
    {
...
template<class BasicTurbulenceModel>
void kOmegaSSTGamIDDES<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void kOmegaSSTGamIDDES<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
